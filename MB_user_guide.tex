...
\title{ \textsc{\huge MainBoard User Manual} \\ \textsc{A guide to using MainBoard middleware} \\ \textsc{\small v 1.1}}
\author{UNIZG}
...
\input{content/Connecting_to_BLE_device.tex}
\input{content/Programming_using_Bootloader.tex}
%\input{content/Setting_up_environment.tex}
\input{content/Testing_device_functionality.tex}
%\input{content/Testing_scenarios.tex}
